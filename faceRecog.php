...
function getFaceId(){
    ...
    $url = 'https://eastus.api.cognitive.microsoft.com/face/v1.0/detect?returnFaceId=true&returnFaceLandmarks=false&returnFaceAttributes={smile}';
    //$param = "{\"url\":\"".$img_path."\"}";
