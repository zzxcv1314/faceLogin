...
function getFaceId(){
    ...
    $url = 'https://eastus.api.cognitive.microsoft.com/face/v1.0/detect?returnFaceId=true&returnFaceLandmarks=false&returnFaceAttributes=age,emotion';
    //$param = "{\"url\":\"".$img_path."\"}";
    ...
    $faceemo = $json[0]['faceAttributes']['emotion'][1];
